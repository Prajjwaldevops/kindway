                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919198846529" className="text-gray-600 hover:text-accent transition">+91 91988 46529</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:info@kindwaybio.com" className="text-gray-600 hover:text-accent transition">info@kindwaybio.com</a>
                                    </div>
                                </div>
