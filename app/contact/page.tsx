    ...
    return (
        <>
            ...
            <section className="bg-gradient-to-b from-blue-600/20 to-[#0A0F1E] py-20 md:py-32 pt-32 relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/images/b2.jpg')] bg-cover bg-center opacity-10"></div>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            <div>
                                <span className="text-amber-500 font-semibold tracking-wider text-sm uppercase mb-2 block">Reach Out</span>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://maps.google.com/?q=Kindway+Biorezens+Pvt.+Ltd.+Varanasi+Uttar+Pradesh+India" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-400 transition">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919198846529" className="text-gray-400 hover:text-amber-400 transition">+91 91988 46529</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:info@kindwaybio.com" className="text-gray-400 hover:text-amber-400 transition">info@kindwaybio.com</a>
                                    </div>
                                </div>
