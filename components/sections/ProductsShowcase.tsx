            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {featuredProducts.map((product) => (
                        <Card key={product.slug} className="group flex flex-col h-full border-gray-100 hover:border-primary/20 bg-gray-50/50 hover:bg-white transition-colors duration-300">
